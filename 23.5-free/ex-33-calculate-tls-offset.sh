...
# 
#   On 23ai free edition, a SEARCH_OFFSET of 1 MB 
#   (0x100000) is too large and results in an error.
#   Therefore, we the script uses a smaller offset of 
#   only 512 KB (0x80000).

SEARCH_OFFSET="0x80000"
